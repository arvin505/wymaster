...
public final class CameraManager {
     ...
     *
     * @param pcontext The Activity which wants to use the camera.
     */
     ...
     *
     * @param handlerletter The handlerletter to send the message to.
     ...
     *
     * @param handlerletter The Handler to notify when the autofocus completes.
