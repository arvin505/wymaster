...
public class McoySnapPageLayout extends ViewGroup {
    ...
    public interface PageSnapedListener {
        ...
        /**
         * @param derection 1表示从上面滑到下面时调用，-1表示从下面滑到上面时调用
         */
...
//				}
    ...
    private boolean recyclerviewIsTop = true;

    public void setOnRecyclerviewIsTop(boolean recyclerviewIsTop) {
        this.recyclerviewIsTop = recyclerviewIsTop;
    }
