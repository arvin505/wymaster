...
public class PullToRefreshLayout extends RelativeLayout {
     ...
     * 执行自动回滚的handler
     */
    Handler updateHandler = new MHandler();
    private Animation noDataAnimation;
    private LayoutParams params;
    private View noDataView;
    private ImageView noDataTmage;
    ...
    public void refreshFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                // 刷新成功
                noDataTmage.setImageResource(R.drawable.bg_icon_null);
            ...
            default:
                // 刷新失败
                noDataTmage.setImageResource(R.drawable.bg_icon_nonet);
                refreshStateImageView.setVisibility(View.VISIBLE);
        ...
        new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (pullableView instanceof ListView) {
                    if (((ListView) pullableView).getAdapter().getCount() == 0) {

                        noDataView.setVisibility(View.VISIBLE);
                        noDataTmage.setAnimation(noDataAnimation);
                        noDataTmage.startAnimation(noDataAnimation);
                    } else {
    ...
    private void initView() {
        noDataTmage = (ImageView) noDataView.findViewById(R.id.noDataImage);
        // 初始化下拉布局
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        noDataView.layout(0, (int) (pullDownY + pullUpY), pullableView.getMeasuredWidth(), (int) (pullDownY + pullUpY)
                + pullableView.getMeasuredHeight() * 2 / 3);
