...
/**
 * 上下左右滑动
 * Created by zhaosent on 2016/7/6.
 */
public class HVScrollView extends FrameLayout {
    ...
    public interface isHVScrollViewMobile{
        void isMobile(boolean isMobile);
    };

    public isHVScrollViewMobile isHVScrollViewMobile;

    public void setIsHVScrollViewMobile(isHVScrollViewMobile isHVScrollViewMobile){
        this.isHVScrollViewMobile = isHVScrollViewMobile;
    }
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mIsBeingDragged) {
                    ...
                    mLastMotionX = x;
                    if(isHVScrollViewMobile != null){
                        isHVScrollViewMobile.isMobile(true);
                    }
