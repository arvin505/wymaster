...
import com.miqtech.master.client.view.pullToRefresh.PullToRefreshBase.Mode;
import com.miqtech.master.client.view.pullToRefresh.PullToRefreshBase.Orientation;
...
public class FlipLoadingLayout extends LoadingLayout {
	...
	protected int getDefaultDrawableResId() {
		return R.drawable.pr_default_ptr_rotate;
	}
	...
	protected void refreshingImpl() {
		if (null != mHeaderImage) {
			Animation anim = AnimationUtils.loadAnimation(getContext(), R.anim.pr_pull_refresh_loading);
