 ...
 */
public class MyHistoryRedBagActivity extends RedbagBaseActivity implements ViewPager.OnPageChangeListener, View.OnClickListener,
...
/*        red_btn = (ImageView) findViewById(R.id.ibRight);
        ...
        bundle.putInt("type", TYPE_HISTORY);
