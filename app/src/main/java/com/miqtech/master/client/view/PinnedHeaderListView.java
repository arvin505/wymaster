...
import com.miqtech.master.client.adapter.ContactPinnedHeaderAdapter;
import com.miqtech.master.client.listviewfilter.IIndexBarFilter;
...
public class PinnedHeaderListView extends ListView implements IIndexBarFilter {
	...
	int mHeaderViewWidth, mHeaderViewHeight, mIndexBarViewWidth, mIndexBarViewHeight, mIndexBarViewMargin,
	...
	public void setAdapter(ListAdapter adapter) {
		if(adapter instanceof ContactPinnedHeaderAdapter){
			this.mAdapter = (ContactPinnedHeaderAdapter) adapter;
		}else if(adapter instanceof PinnedHeaderAdapter){
	...
	protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
		...
		if (mPreviewTextView != null && mPreviewVisibility) {
			mPreviewTextView.layout(mIndexBarView.getLeft() - mPreviewTextViewWidth, (int) mIndexBarY
					- (mPreviewTextViewHeight / 2), mIndexBarView.getLeft(),
					(int) (mIndexBarY - (mPreviewTextViewHeight / 2)) + mPreviewTextViewHeight);
		}
	}
