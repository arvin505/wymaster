 ...
 */
public class FragmentHotSort extends BaseFragment implements RefreshLayout.OnLoadListener {

    private View mainView;
    private Context mContext;
    private RefreshLayout refreshView;
    private ListView lvHotSort;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mainView == null) {
            mainView = inflater.inflate(R.layout.activity_hot_sort, null);
...
//        mainView = inflater.inflate(R.layout.activity_hot_sort, container, false);
//        mContext = inflater.getContext();
        return mainView;
    }

    private void initView() {
        refreshView = (RefreshLayout) mainView
                .findViewById(R.id.refresh_view);
        lvHotSort = (ListView) mainView.findViewById(R.id.lvHotSort);
        adapter = new WeekHotAdapter(mContext, gameList, listen);
        lvHotSort.setAdapter(adapter);
    ...
    private void loadWeekHotData() {
        ...
        map.put("page", page + "");
        map.put("rows", rows + "");
        sendHttpPost(HttpConstant.SERVICE_HTTP_AREA + HttpConstant.GAME_HOT_SORT_LIST, map, HttpConstant.GAME_HOT_SORT_LIST);
    }
    ...
    public void onSuccess(JSONObject object, String method) {
        try {
            ...
            if (method.equals(HttpConstant.GAME_HOT_SORT_LIST)) {
                if (obj == null) {
                    return;
                }
