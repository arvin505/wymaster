...
/**
 * 滑动删除myScanListview的item最外层布局
 * zhaosentao
 */
public class MyScanItemLinearLayout extends LinearLayout {
    ...
    public MyScanItemLinearLayout(Context context) {
        this(context, null);
    }

    public MyScanItemLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
