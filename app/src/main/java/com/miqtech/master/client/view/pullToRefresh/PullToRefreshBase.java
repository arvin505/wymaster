 ...
 *******************************************************************************/
package com.miqtech.master.client.view.pullToRefresh;
...
import com.miqtech.master.client.view.pullToRefresh.internal.FlipLoadingLayout;
import com.miqtech.master.client.view.pullToRefresh.internal.RotateLoadingLayout;
import com.miqtech.master.client.view.pullToRefresh.internal.Utils;
import com.miqtech.master.client.view.pullToRefresh.internal.ViewCompat;
...
//	}
	...
	protected final void setHeaderScroll(int value) {
		...
		Log.i("SmoothScrollRunnable","maximumPullScroll"+maximumPullScroll+":::"+value);
		if (USE_HW_LAYERS) {
			/**
	...
	private void callRefreshListener() {
		boolean isHasNetWork=true;
		if (!isNetworkConnected(this.getContext())) {
			isHasNetWork=false;
		}
		if (null != mOnRefreshListener) {
			mOnRefreshListener.onRefresh(this);
			mOnRefreshListener.isHasNetWork(isHasNetWork);
		} else if (null != mOnRefreshListener2) {
			if (mCurrentMode == Mode.PULL_FROM_START) {
				mOnRefreshListener2.onPullDownToRefresh(this);
				mOnRefreshListener2.isHasNetWork(isHasNetWork);
	...
	final class SmoothScrollRunnable implements Runnable {
		...
		public void run() {
			...
			//TODO 此处去做处理 减缓回滚的速度
				...
				int y=0;
                 if(y<=-105){
					 y=(int)(-105-(deltaY+105)*0.1);
				 }else{
                    y=deltaY;
				 }
			//		mCurrentY = mScrollFromY - deltaY; //一直变化的值-165---0
				mCurrentY = mScrollFromY - y; //一直变化的值-165---0
				Log.i("SmoothScrollRunnable","mScrollFromY"+mScrollFromY+":::"+mScrollToY+":::"+deltaY+"::::"+mCurrentY+"::"+y);
