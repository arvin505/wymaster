// @author Bhavya Mehta
package com.miqtech.master.client.listviewfilter;
...
public class PinnedHeaderAdapter extends BaseAdapter implements OnScrollListener, IPinnedHeader, Filterable {
	...
	public PinnedHeaderAdapter(Context context,List<Object> listItems,List<Integer> listSectionPos) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(mListItems.get(position) instanceof City){
			holder.textView.setText(((City)mListItems.get(position)).getName());
		}else{
			holder.textView.setText((String)mListItems.get(position));
		}
