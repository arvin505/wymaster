...
public class CustomDelegate extends Delegate {
    ...
    private LinearLayout llSina, llWeChat, llFriend, llQQ;
    ...
    public View createView() {
        ...
        llSina = (LinearLayout) rootView.findViewById(R.id.llSina);
