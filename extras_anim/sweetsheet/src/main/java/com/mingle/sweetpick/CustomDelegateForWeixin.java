 ...
 */
public class CustomDelegateForWeixin extends Delegate {
    ...
    private LinearLayout  llWeChat, llFriend;


    public CustomDelegateForWeixin(boolean dragEnable, AnimationType contentViewAnimationType) {
        mIsDragEnable = dragEnable;
        mContentViewAnimationType = contentViewAnimationType;
    }

    public CustomDelegateForWeixin(boolean dragEnable, AnimationType contentViewAnimationType, int contentViewHeight) {
    ...
    public View createView() {
        ...
        View rootView = LayoutInflater.from(mParentVG.getContext())
                .inflate(R.layout.layout_custom_sweet_weixin, null, false);
        ...
        // llSina,llWeChat,llFriend,llQQ;
        llWeChat = (LinearLayout) rootView.findViewById(R.id.llWeChat);
        llFriend = (LinearLayout) rootView.findViewById(R.id.llFriend);

        OnMyShareClickListener onMyShareClickListener = new OnMyShareClickListener();
        llWeChat.setOnClickListener(onMyShareClickListener);
        llFriend.setOnClickListener(onMyShareClickListener);
    ...
    public interface OnShareClickListener {
        /**
         * 分享 R.id.llSina,R.id.llWeChat,R.id.llFriend,R.id.llQQ
         *
         * @param v
         */
        void onShareClickListener(View v);
    }

    public OnShareClickListener onMyShareClickListener;
     ...
     * R.id.llQQ,QQ
     *
     * @param onMyShareClickListener
     */
    public void setOnShareClickListener(OnShareClickListener onMyShareClickListener) {
        this.onMyShareClickListener = onMyShareClickListener;
    }

    class OnMyShareClickListener implements View.OnClickListener {
        @Override
        public void onClick(View v) {
            onMyShareClickListener.onShareClickListener(v);
        }
    }
    ...
    public CustomDelegateForWeixin setContentHeight(int height) {
    ...
    public CustomDelegateForWeixin setCustomView(View view) {
        if (mContentRL != null) {
            mContentRL.removeAllViews();
    ...
    public CustomDelegateForWeixin setCustomView(View view, RelativeLayout.LayoutParams params) {
        if (mContentRL != null) {
            mContentRL.removeAllViews();
     ...
     */
    public CustomDelegateForWeixin setCustomViewAnimation(ValueAnimator viewAnimation) {
