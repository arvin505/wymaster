...
import com.mingle.listener.SingleClickListenerForSweet;
...
public class MenuRVAdapter extends RecyclerView.Adapter<MenuRVAdapter.MenuVH> {
    ...
    public void onBindViewHolder(MenuVH menuVH, int i) {
        ...
        menuVH.itemRl.setOnClickListener(mSingleClickListenerForSweet);
    ...
    private SingleClickListenerForSweet mSingleClickListenerForSweet = new SingleClickListenerForSweet(new View.OnClickListener() {
        @Override
