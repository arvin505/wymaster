 ...
 * @date 2015/7/9.
 */
public class AnimetionImageView extends android.widget.ImageView implements CircleRevealEnable,SkinEnable {

    private CircleRevealHelper mCircleRevealHelper ;
    private SkinHelper mSkinHelper;

    public AnimetionImageView(Context context) {
        super(context);
        init(null);

    }

    public AnimetionImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
    ...
    public AnimetionImageView(Context context, AttributeSet attrs, int defStyleAttr) {
