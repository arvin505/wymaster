 ...
 */
public class AnimetionRadioButton extends AppCompatRadioButton implements CircleRevealEnable,SkinEnable {

    private CircleRevealHelper mCircleRevealHelper ;
    private SkinHelper mSkinHelper;

    public AnimetionRadioButton(Context context) {
        super(context);
        init(null);

    }

    public AnimetionRadioButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
    ...
    public AnimetionRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
