 ...
 */
public class AnimetionFrameLayout extends android.widget.FrameLayout implements CircleRevealEnable,SkinEnable {

    private CircleRevealHelper mCircleRevealHelper ;
    private SkinHelper mSkinHelper;

    public AnimetionFrameLayout(Context context) {
        super(context);
        init(null);

    }

    public AnimetionFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
    ...
    public AnimetionFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @Override
    public AnimetionFrameLayout.LayoutParams generateLayoutParams(AttributeSet attrs) {
    ...
    public  class AnimetionSLayoutParams extends android.widget.FrameLayout.LayoutParams implements AnimetionSLayoutParamsI {
        ...
        public AnimetionSLayoutParams(android.widget.FrameLayout.LayoutParams source) {
            super(source);
        }
    }
}
