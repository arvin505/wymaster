 ...
 */
public class AnimetionCheckedTextView extends AppCompatCheckedTextView implements CircleRevealEnable,SkinEnable {

    private CircleRevealHelper mCircleRevealHelper ;
    private SkinHelper mSkinHelper;

    public AnimetionCheckedTextView(Context context) {
        super(context);
        init(null);

    }

    public AnimetionCheckedTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
    ...
    public AnimetionCheckedTextView(Context context, AttributeSet attrs, int defStyleAttr) {
