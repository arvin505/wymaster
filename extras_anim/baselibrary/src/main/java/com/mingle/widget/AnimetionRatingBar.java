 ...
 */
public class AnimetionRatingBar extends AppCompatRatingBar implements CircleRevealEnable,SkinEnable {

    private CircleRevealHelper mCircleRevealHelper ;
    private SkinHelper mSkinHelper;

    public AnimetionRatingBar(Context context) {
        super(context);
        init(null);

    }

    public AnimetionRatingBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
    ...
    public AnimetionRatingBar(Context context, AttributeSet attrs, int defStyleAttr) {
