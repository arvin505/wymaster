 ...
 */
public class AnimetionImageButton extends android.widget.ImageButton implements CircleRevealEnable,SkinEnable {

    private CircleRevealHelper mCircleRevealHelper ;
    private SkinHelper mSkinHelper;

    public AnimetionImageButton(Context context) {
        super(context);
        init(null);

    }

    public AnimetionImageButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
    ...
    public AnimetionImageButton(Context context, AttributeSet attrs, int defStyleAttr) {
