 ...
 */
public class AnimetionEditText extends AppCompatEditText implements CircleRevealEnable,SkinEnable {

    private CircleRevealHelper mCircleRevealHelper ;
    private SkinHelper mSkinHelper;

    public AnimetionEditText(Context context) {
        super(context);
        init(null);

    }

    public AnimetionEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
    ...
    public AnimetionEditText(Context context, AttributeSet attrs, int defStyleAttr) {
